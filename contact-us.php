...
<section class="ai-tools-section section-space-top home-7-section-top-border">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center">
                    <span
                        class="rounded-1 bg-grad-6 bg-opacity-2 clr-white fs-12 fw-bold px-4 py-2 d-inline-block mb-4 fadeIn_bottom">Contact
                        Us</span>
            ...
            <div class="col-lg-5">
                        ...
                        <form>
                            <div class="mt-8">
                                ...
                                <input type="email" name="#0"
                                    class="form-control border border-neutral-17 clr-neutral-90 :focus-clr-current rounded-2 py-4 px-4 bg-transparent placeholder-50 focus-bg-none"
                            ...
                            <button type="submit"
                                class="link d-inline-flex justify-content-center align-items-center gap-2 py-4 px-6 border border-primary-key bg-grad-6 rounded-1 fw-bold clr-white border-0 w-100 mt-8 :arrow-btn">
                                <span>Submit</span>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="col-lg-12 col-md-6">
                            <div class="ai-tools-card text-center overflow-hidden py-10 px-8 h-100 fadeIn_bottom"
                                data-tilt data-tilt-max="0" data-tilt-glare data-tilt-max-glare="0.15">
                                <div class="mt-2 mb-10 ai-tools-card-globe">
                                    <img src="assets/img/ai-tools-card-img-3-globe.png" alt="image" class="img-fluid">
                                    <img src="assets/img/ai-tools-card-img-3-flag.png" alt="image"
                                        class="img-fluid ai-tools-card-flag">
                                </div>
                                ...
                                <p class="clr-neutral-80 mb-0">AI-powered translation tools Save per day on ad
                                    management</p>
                                <img src="assets/img/ai-tools-card-shape-3.png" alt="image"
                                    class="img-fluid ai-tools-card-shape">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6">
                            <div class="ai-tools-card text-center overflow-hidden py-10 px-8 h-100 fadeIn_bottom"
                                data-tilt data-tilt-max="0" data-tilt-glare data-tilt-max-glare="0.15">
                                <img src="assets/img/ai-tools-card-img-1.png" alt="image"
                                    class="img-fluid mt-2 mb-5 img-gray">
                                <h4 class="clr-neutral-90 fs-18 fw-semibold">Advance Dashboard</h4>
                                <p class="clr-neutral-80 mb-0">AI-powered translation tools Save per day on ad
                                    management</p>
                                <img src="assets/img/ai-tools-card-shape-1.png" alt="image"
                                    class="img-fluid ai-tools-card-shape">
                            </div>
                        </div>
                    </div>
    ...
    <img src="assets/img/ai-tools-shape-left-start.png" alt="image"
        class="img-fluid ai-tools-section-left-start parallax">
    <img src="assets/img/ai-tools-shape-right-start.png" alt="image"
        class="img-fluid ai-tools-section-right-start parallax">
</section>
