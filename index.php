                    ...
                    <ul class="list list-row gap-10 scroller-x__list">
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/spotify.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-1.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-2.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-3.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-4.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-5.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-6.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-7.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-8.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-9.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-10.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-11.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                                <img src="assets/img/brand-icon-12.png" alt="image" class="img-fluid">
                            </div>
                        </li>
                        <li>
                            <div class="brand-btn d-inline-block">
                    ...
                    <div class="col-lg-4 col-xl-5">
                        <div class="d-flex align-items-center gap-3 fadeIn_bottom">
                            <span class="d-inline-block flex-shrink-0">
                                <img src="assets/img/icon-subtitle.png" alt="image" class="img-fluid">
                            </span>
                            <span class="d-inline-block clr-secondary-key ff-1 fw-bold fs-18"> 500+ Customer Rating
                            </span>
                        </div>
                    </div>
                            ...
                            <div class="d-flex justify-content-center gap-4 scroller-card fadeIn_bottom">
                                <div class="scroller-y" data-direction="top" data-speed="slow">
                                    <ul class="list gap-4 scroller-y__list">
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-1.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-2.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-3.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-4.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-5.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-6.png" alt="image">
                                        </li>
                                    </ul>
                                </div>
                                <div class="scroller-y" data-direction="bottom" data-speed="slow">
                                    <ul class="list gap-4 scroller-y__list">
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-7.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-8.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-9.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-10.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-11.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-12.png" alt="image">
                                        </li>
                                    </ul>
                                </div>
                                <div class="scroller-y" data-direction="top" data-speed="slow">
                                    <ul class="list gap-4 scroller-y__list">
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-13.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-14.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-15.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-16.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-17.png" alt="image">
                                        </li>
                                        <li>
                                            <img class="img-fluid" src="assets/img/thumb-18.png" alt="image">
                                        </li>
                                    </ul>
                                </div>
                                <div class="scroller-y" data-direction="bottom" data-speed="slow">
...
<!-- Blog Section  -->
<div class="blog-section-1 section-space-y bg-neutral-1">
    <div class="section-space-sm-bottom">
        <div class="container">
            <div class="row g-4 justify-content-between">
                <div class="col-md-5">
