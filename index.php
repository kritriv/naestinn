                ...
                <div data-bs-spy="scroll" data-bs-target="#toDoScrollspy" data-bs-smooth-scroll="true">
                    ...
                    <div id="aiml">
                        <div class="todo-box position-relative z-1 bg_back_dark_2 py-10 pe-10">
                            ...
                            <p class="mb-6 clr-neutral-80 animate-text-from-right"> Embark on a journey of discovery
                                with Naestinn's AI & ML mavens. We breathe life into data, unraveling insights that
                    ...
                    <div id="designing">
                        <div class="todo-box position-relative z-1 bg_back_dark_2 py-10 pe-10">
                            ...
                            <p class="mb-6 clr-neutral-80 animate-text-from-right"> Dive into the realm of creativity
                                with Naestinn's fusion artists. Where pixels meet purpose and design transcends
                    ...
                    <div id="digitalmarketing">
                        <div class="todo-box position-relative z-1 bg_back_dark_2 py-10 pe-10">
                            ...
                            <p class="mb-6 clr-neutral-80 animate-text-from-right"> Navigate the online world with
                                Naestinn's savvy strategists. We make your brand shine bright in the digital crowd,
