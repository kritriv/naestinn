                                    ...
                                    <ul class="list menu-sub">
                                        <li class="menu-sub-list">
                                            <a href="index.php" class="link menu-sub-link gap-4">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-image-icon.png" alt="image"
                                                        class="img-fluid">
                                        ...
                                        <li class="menu-sub-list">
                                            <a href="index-2.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-saas-icon.png" alt="image"
                                                        class="img-fluid">
                                                </span> AI SaaS </a>
                                        </li>
                                        <li class="menu-sub-list">
                                            <a href="index-3.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-chatbot-icon.png" alt="image"
                                                        class="img-fluid">
                                                </span> AI Chatbot </a>
                                        </li>
                                        <li class="menu-sub-list">
                                            <a href="index-4.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-content-icon.png" alt="image"
                                                        class="img-fluid">
                                        ...
                                        <li class="menu-sub-list">
                                            <a href="index-5.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-voice-icon.png" alt="image"
                                                        class="img-fluid">
                                        ...
                                        <li class="menu-sub-list">
                                            <a href="index-6.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-video-icon.png" alt="image"
                                                        class="img-fluid">
                                        ...
                                        <li class="menu-sub-list">
                                            <a href="index-7.php" class="link menu-sub-link gap-3">
                                                <span class="d-none d-lg-inline-block">
                                                    <img src="assets/img/ai-saas-icon-2.png" alt="image"
                                                        class="img-fluid">
                                                </span> AI Naest In </a>
                                        </li>
                                    </ul>
