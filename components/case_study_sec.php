            ...
            <div class="col-12">
                <ul class="nav nav-underline nav-bordered use-case-tab">
                    <li class="nav-item animate-text-from-right">
                        <a class="nav-link active" type="button" data-bs-toggle="tab" data-bs-target="#software_development_case_study">
                    ...
                    <li class="nav-item animate-text-from-right">
                        <a class="nav-link " type="button" data-bs-toggle="tab" data-bs-target="#website_development_case_study"> Web Development </a>
                    </li>
                    <li class="nav-item animate-text-from-right">
                        <a class="nav-link " type="button" data-bs-toggle="tab" data-bs-target="#aiml_case_study"> AI &
                            ML </a>
                    </li>
                    <li class="nav-item animate-text-from-right">
                        <a class="nav-link" type="button" data-bs-toggle="tab" data-bs-target="#designing_case_study">
                            Designing </a>
                    </li>
                    <li class="nav-item animate-text-from-right">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="software_development_case_study" role="tabpanel" aria-labelledby="software_development_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                <div class="col-lg-6 col-xxl-5">
                                    ...
                                    <a href="featured.php" class="link d-inline-block py-3 px-6 ff-1 bg-grad-6 clr-white fw-bold rounded">
                                        Explore </a>
                                </div>
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img src="assets/images/Case-Study/Software-dev-home.webp" alt="Software Development" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="app_development_case_study" role="tabpanel" aria-labelledby="app_development_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img src="assets/images/Case-Study/app-dev-home.webp" alt="Application Development" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade " id="website_development_case_study" role="tabpanel" aria-labelledby="website_development_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                <div class="col-lg-6 col-xxl-5">
                                    ...
                                    <a href="featured.php" class="link d-inline-block py-3 px-6 ff-1 bg-grad-6 clr-white fw-bold rounded fadeIn_bottom">
                                        Explore </a>
                                </div>
                                <div class="col-lg-6">
                                    <div class="text-center fadeIn_bottom">
                                        <img src="assets/images/Case-Study/web-dev-home.webp" alt=" Web Development" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade " id="aiml_case_study" role="tabpanel" aria-labelledby="aiml_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                <div class="col-lg-6 col-xxl-5">
                                    <h5 class="fw-extrabold clr-neutral-90 animate-line-3d"> Digital Excellence:
                                        Crafting Engaging AI & ML Experiences </h5>
                                    <p class="mb-7 fw-medium clr-neutral-80 animate-text-from-right"> Discover how
                                        Næstinn elevated a brand's online presence through captivating AI & ML,
                                        creating user-centric and visually appealing Ai software. </p>
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center fadeIn_bottom">
                                        <img src="assets/images/Case-Study/aiml-home.webp" alt="AI & ML" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="designing_case_study" role="tabpanel" aria-labelledby="designing_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                <div class="col-lg-6 col-xxl-5">
                                    <h5 class="fw-extrabold clr-neutral-90"> Designing Experiences: Næstinn's Designing
                                        Showcase </h5>
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img src="assets/images/Case-Study/uiux-design-home.webp" alt="Designing" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="digital_marketing_case_study" role="tabpanel" aria-labelledby="digital_marketing_case_study" tabindex="0">
                        <div class="pt-12">
                            <div class="row g-4 align-items-center justify-content-between">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <img src="assets/images/Case-Study/digital-marketing-home.webp" alt="Digital Marketing" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
